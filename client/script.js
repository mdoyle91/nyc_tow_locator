...
searchButton.addEventListener(`click`, async () => {
  ...
  try {
    //Got the suggestion to input a try from ChatGPT. I had some issues with the logic for the search field. It would take whatever came first, but after trying to alter the code in various ways with ChatGPT, I ended up creating to separate try statements, rather than an else statement within this try & that works.
...
// Front end CUD functionality--Utilized this source throughout for guidance in the code https://agirlcodes.medium.com/build-a-crud-todo-app-with-vanilla-javascript-and-fetch-api-44a664c0de52, then had ChatGPT help finesse some of the code (i.e. asking it to use axios gets instead of await fetch, and also dialoguing with it until I could get the desired functionality on the page.)--I ended up deleting everything from the article and dialoguging back and forth with ChatGPT as what I was trying to get from the article was too piecemiel for my needs. Everything below was generated by ChatGPT, but I feel like I can explain it/understand the logic of it for the most part.
